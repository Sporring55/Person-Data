...
<h1 id="head">Tilføj Person-Data </br > 1 År</h1>
<?php
if(isset($_POST["submit"])){
    ...
    if(empty($data_miss)){
        ...
        if($stmt = mysqli_prepare($dbc, "INSERT INTO etÅr (navn, adresse,  email, num, sted, post, andbefal, oversag, bemærk1, bemærk2) VALUES (?,?,?,?,?,?,?,?,?,?)")){
...
?>
<form action="http://localhost:8888/Git-hub/Person-data/Ind/aa1/addedlager.php" method="post">
